    ...
    public partial class Form1 : Form
    {
        ...
        private void ChangeNicks_Click_1(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    new Thread(delegate ()
                    {
                        this.ChangeNicknames(server, nick);
                    }).Start();
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        for (int j = 0; j < 10; j++)
                        {
                            new Thread(delegate ()
                            {
                                while (Form1.Running) { this.SpamDmNigga(); }
                            }).Start();
                        }
                    }
                }
        ...
        public void ResetNicknames(string ServerID)
        {
            ...
            foreach (string token in Form1.ValidTokens)
            {
                try
                {
                    rDiscord.ResetNick(Client.Create(false, null, token), ServerID);
                    num++;
                }
                catch { }
            }
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        for (int i = 0; i < this.boostisThread.Value; i++)
                        {
                            new Thread(delegate ()
                            {
                                while (Form1.Running) { this.MultiChannel(); }
                            }).Start();
                        }
                    }
                }
